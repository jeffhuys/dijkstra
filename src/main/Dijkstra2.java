...
public class Dijkstra2
{
    ...
    {
        Vertex v0 = new Vertex("Station 1");
	Vertex v1 = new Vertex("Station 2");
	Vertex v2 = new Vertex("Station 3");
	Vertex v3 = new Vertex("Station 4");
	Vertex v4 = new Vertex("Station 5");
	Vertex v5 = new Vertex("Station 6");
	Vertex v6 = new Vertex("Station 7");
